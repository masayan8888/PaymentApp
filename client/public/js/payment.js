...
// ---------------------------
var stripe = Stripe("pk_test_51OFuOwHgEZ9PfviOlhFrEBW7XoYzC41X04oLB10R0iQIXrMWa8vz676s4ZglNSKU8kCygJkf9Vq6EIZ0VobkCRO200hEpOEq1c");  // キーがないとインスタンスを生成できない、後工程で作成する
    ...
    stripe
        ...
        .then(function (result) {
            ...
            if (result.error) {
                ...
                // サーバー http://localhost:3000/v1/order/payment にPOSTでリクエストを受け付けている
                fetch("https://58cqcccdm1.execute-api.ap-northeast-1.amazonaws.com/test/stripe", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(order) })
                    .then(function (result) {
